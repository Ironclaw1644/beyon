...
export async function GET() {
  ...
  const headers = ['id', 'email', 'name', 'source', 'status', 'opted_in', 'confirmed_at', 'consent_source', 'consent_at', 'unsubscribe_reason', 'unsubscribed_at', 'bounced_at', 'complaint_at', 'created_at'];
